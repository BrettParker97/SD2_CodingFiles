...
VL53L0X_Error VL53L0X_ReadMulti_ex(VL53L0X_DEV Dev, uint16_t index, uint8_t *pdata, uint32_t count) {
    VL53L0X_Error Status = VL53L0X_ERROR_NONE;
    int32_t status_int;
    VL53L0X_GetI2cBus();
...
VL53L0X_Error VL53L0X_WrByte_ex(VL53L0X_DEV Dev, uint16_t index, uint8_t data) {
    VL53L0X_Error Status = VL53L0X_ERROR_NONE;
    int32_t status_int;
...
VL53L0X_Error VL53L0X_RdByte_ex(VL53L0X_DEV Dev, uint16_t index, uint8_t *data) {
    VL53L0X_Error Status = VL53L0X_ERROR_NONE;
    int32_t status_int;
